...
**Table S2**: the percentage of female offspring that inherited a _SD_ allele from a heterozygous parent _k_, split by the sex of the parent. _SD_ only drives when present in males. n = 14-15 for all groups.
...
**Table S5a**: the mean time taken for _SD/+_ or control males to start mating with a _LH~m~_ female.
